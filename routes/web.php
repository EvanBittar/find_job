...
Route::middleware(['guest'])->group(function () {
    Route::get('/login',[SessionCollector::class,'login'])->name('login');
    Route::post('/login',[SessionCollector::class,'store'])->name('account.processLogin');
    
    Route::get('/register',[RegisterUserController::class,'register'])->name('register');
    Route::post('/register',[RegisterUserController::class,'store'])->name('account.processRegister');
});
